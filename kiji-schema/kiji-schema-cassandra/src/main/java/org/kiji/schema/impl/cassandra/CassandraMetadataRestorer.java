...
public class CassandraMetadataRestorer {
  private static final Logger LOG = LoggerFactory.getLogger(CassandraMetadataRestorer.class);
   ...
   * @throws java.io.IOException when an error communicating with HBase or the filesystem occurs.
   */
