 ...
 *
 */
public class JsonToKijiRestEntityId extends JsonDeserializer<KijiRestEntityId> {

  /**
   * {@inheritDoc}
   */
  @Override
  public KijiRestEntityId deserialize(JsonParser parser, DeserializationContext context)
      throws IOException {
