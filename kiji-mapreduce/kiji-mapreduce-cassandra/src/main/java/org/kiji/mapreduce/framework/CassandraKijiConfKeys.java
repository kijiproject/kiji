...
public final class CassandraKijiConfKeys {
  ...
  /** Desired number of input splits. */
  public static final String TARGET_NUMBER_OF_CASSANDRA_INPUT_SPLITS = "kiji.input.splits.target";

  /** Utility class may not be instantiated. */
  private CassandraKijiConfKeys() {
  }
}
