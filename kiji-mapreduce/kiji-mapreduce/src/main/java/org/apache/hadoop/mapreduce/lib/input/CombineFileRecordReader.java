 ...
 *
 * <p>Note that this class has been edited slightly from the hadoop 0.21 release.
 * In this version, initNextRecordReader() does not set the JobConfig variables named</p>
 * <ul>
 *   <li>MRJobConfig.MAP_INPUT_FILE</li>
 *   <li>MRJobConfig.MAP_INPUT_START</li>
 *   <li>MRJobConfig.MAP_INPUT_PATH</li>
 * </ul>
 *
...
public class CombineFileRecordReader<K, V> extends RecordReader<K, V> {
   ...
   *
   * This function has been edited.  Unlike the hadoop 0.21.0 release, this function
   * does NOT set the Configuration variables named
   * <ul>
   *   <li>MRJobConfig.MAP_INPUT_FILE</li>
   *   <li>MRJobConfig.MAP_INPUT_START</li>
   *   <li>MRJobConfig.MAP_INPUT_PATH</li>
  ...
  protected boolean initNextRecordReader() throws IOException {
    ...
    try {
      curReader =  rrConstructor.newInstance(
          new Object [] {split, context, Integer.valueOf(idx)});
      if (idx > 0) {
