...
public class KijiMultithreadedMapper<K, V>
  ...
  private Class<? extends Mapper<EntityId,KijiRowData,K,V>> mapClass;
  ...
  public static <K,V> Class<Mapper<EntityId,KijiRowData,K,V>> getMapperClass(JobContext job) {
    return (Class<Mapper<EntityId,KijiRowData,K,V>>)
  ...
  public static <K,V> void setMapperClass(Job job,
      Class<? extends Mapper<EntityId,KijiRowData,K,V>> cls) {
  ...
  private class SubMapRecordReader extends RecordReader<EntityId,KijiRowData> {
    private EntityId key;
    private KijiRowData value;
  ...
  private class MapRunner extends Thread {
    private Mapper<EntityId,KijiRowData,K,V> mapper;
