...
public final class KijiConfKeys {
  ...
  /** Fully qualified name of the {@link org.kiji.mapreduce.tools.KijiGather} class to run. */
  public static final String KIJI_GATHERER_CLASS = "kiji.gatherer.class";

  /** Fully qualified name of the {@link org.kiji.mapreduce.produce.KijiProducer} class to run. */
  public static final String KIJI_PRODUCER_CLASS = "kiji.producer.class";

  /**
   * Fully qualified name of the {@link org.kiji.mapreduce.bulkimport.KijiBulkImporter} class to
   * run.
   **/
  public static final String KIJI_BULK_IMPORTER_CLASS = "kiji.bulk.importer.class";

  /** Fully qualified name of the {@link org.kiji.mapreduce.pivot.KijiPivoter} class to run. */
