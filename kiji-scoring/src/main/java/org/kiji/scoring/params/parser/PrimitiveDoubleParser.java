...
/**
 * Parser for double parameters.
 */
public class PrimitiveDoubleParser extends NonNullableSimpleValueParser<Double> {
  /** {@inheritDoc} */
  @Override
  ...
  /** {@inheritDoc} */
  @Override
  public Double parseNonNull(ParamSpec param, String string) {
    try {
