...
/**
 * Utilities for working with {@code byte[]}s and {@link ByteBuffer}s. Also see
 * {@link java.util.Arrays}, {@link com.google.common.primitives.Bytes} and
...
public final class ByteUtils {
  ...
  /**
   * Copies the remaining bytes from a {@link ByteBuffer} to a {@code byte[]}. After this method
   * returns, the buffer's position will equal its limit.
   *
