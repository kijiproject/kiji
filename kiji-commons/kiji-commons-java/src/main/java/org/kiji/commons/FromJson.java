  ...
  public static Object fromJsonNode(JsonNode json, Schema schema) throws IOException {
    switch (schema.getType()) {
      ...
      case ARRAY: {
        ...
        final Iterator<JsonNode> it = json.elements();
        while (it.hasNext()) {
      ...
      case MAP: {
        ...
        final Iterator<Map.Entry<String, JsonNode>> it = ((ObjectNode) json).fields();
        while (it.hasNext()) {
      ...
      case RECORD: {
        ...
        final Set<String> fields = Sets.newHashSet(json.fieldNames());
        ...
        for (Schema.Field field : schema.getFields()) {
          ...
          if (fieldElement != null) {
            ...
            record.put(field.pos(),
                fromJsonString(field.defaultValue().toString(), field.schema()));
          } else {
            throw new IOException(String.format(
      ...
      case ENUM: {
        ...
        final String enumValStr = json.asText();
