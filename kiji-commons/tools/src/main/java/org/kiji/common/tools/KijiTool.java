 ...
 * <tt>META-INF/services/org.kiji.common.tools.KijiTool</tt>. You may publish multiple
...
public interface KijiTool {
  ...
  /**
   * @return a hadoop configuration object to use for this tool.
   *
   * Note: This method will not be called in tests, so if you need to modify your configuration,
   *     do so in {@link BaseTool#setup(org.apache.hadoop.conf.Configuration)}
   */
   ...
   */
  int toolMain(final List<String> args, final Configuration configuration) throws Exception;
