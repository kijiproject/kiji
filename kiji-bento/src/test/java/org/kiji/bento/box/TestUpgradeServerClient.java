 ...
 */
public class TestUpgradeServerClient {

  private static final Logger LOG = LoggerFactory.getLogger(TestUpgradeServerClient.class);
  ...
  public void testCheckin() throws IOException, URISyntaxException {
    ...
    UpgradeCheckin checkinMessage = new UpgradeCheckin.Builder()
        .withId("12345")
