...
/**
 * A specification of the runtime bindings needed in the evaluate phase of a model.
 *
 ...
 * @param keyValueStoreSpecs for usage during the evaluate phase.
 */
@ApiAudience.Public
@ApiStability.Experimental
@Inheritance.Sealed
final case class EvaluateEnvironment(
