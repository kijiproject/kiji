 ...
 *     [[org.kiji.express.flow.ColumnRequestOutput]] objects.  This determines how output fields are
...
final case class KijiOutputSpec(
    tableUri: String,
    fieldsToColumns: Map[Symbol, _ <: ColumnRequestOutput],
 ...
 * @param outputColumn a [[org.kiji.express.flow.ColumnRequestOutput]] object that specifies the
...
final case class KijiSingleColumnOutputSpec(
    tableUri: String,
    outputColumn: ColumnRequestOutput)
    extends OutputSpec
