...
Next we create a unique [`EntityId`]({{site.api_schema_1_5_0}}/EntityId.html) that will be used to reference this row.  As before, we will use
...
Kiji bulk import jobs are created by implementing a [`KijiBulkImporter`]({{site.api_mr_1_2_9}}/bulkimport/KijiBulkImporter.html),
...
[`KijiBulkImporter`]({{site.api_mr_1_2_9}}/bulkimport/KijiBulkImporter.html) API below.
...
[`KijiTableContext`]({{site.api_mr_1_2_9}}/KijiTableContext.html) context argument,
...
[`KijiTableWriter`]({{site.api_schema_1_5_0}}/KijiTableWriter.html).
...
and construct a [`KijiMapReduceJob`]({{site.api_mr_1_2_9}}/KijiMapReduceJob.html) (A Kiji-specific wrapper around `Job`):
...
A [`KijiURI`]({{site.api_schema_1_5_0}}/KijiURI.html) is constructed that specifies the `phonebook` table as the target:
...
The [`TextMapReduceJobInput`]({{site.api_mr_1_2_9}}/input/TextMapReduceJobInput.html) and
[`DirectKijiTableMapReduceJobOutput`]({{site.api_mr_1_2_9}}/output/DirectKijiTableMapReduceJobOutput.html)
...
[`KijiMapReduceJobBuilder`]({{site.api_mr_1_2_9}}/KijiMapReduceJobBuilder.html) can use
any [`MapReduceJobInput`]({{site.api_mr_1_2_9}}/MapReduceJobInput.html) and
[`MapReduceJobOutput`]({{site.api_mr_1_2_9}}/MapReduceJobOutput.html) that makes sense
...
[`MapReduceJobInput`]({{site.api_mr_1_2_9}}/MapReduceJobInput.html) and
[`MapReduceJobOutput`]({{site.api_mr_1_2_9}}/MapReduceJobOutput.html)
