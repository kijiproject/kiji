...
[DDL Shell Reference]({{site.userguide_schema_1_4_0}}/schema-shell-ddl-ref/).
...
the layout in JSON, take a look at [Managing Data]({{site.userguide_schema_1_4_0}}/managing-data/).
