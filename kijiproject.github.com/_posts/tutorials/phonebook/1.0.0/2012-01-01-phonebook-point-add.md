...
[`KijiTableWriter`]({{site.api_schema_1_1_0}}/KijiTableWriter.html) class. The phonebook example
includes code that uses a [`KijiTableWriter`]({{site.api_schema_1_1_0}}/KijiTableWriter.html) to
...
The code then connects to Kiji and opens the phonebook table for writing. A [`Kiji`]({{site.api_schema_1_1_0}}/Kiji.html)
instance is specified by a [`KijiURI`]({{site.api_schema_1_1_0}}/KijiURI.html). A Kiji URI specifies an HBase cluster to
...
To create a [`KijiURI`]({{site.api_schema_1_1_0}}/KijiURI.html), you use a
[`KijiURI.KijiURIBuilder`]({{site.api_schema_1_1_0}}/KijiURI.KijiURIBuilder.html)
...
We then create an [`EntityId`]({{site.api_schema_1_1_0}}/EntityId.html) using the contact's first
and last name. The [`EntityId`]({{site.api_schema_1_1_0}}/EntityId.html) uniquely identifies the
...
When a [`Kiji`]({{site.api_schema_1_1_0}}/Kiji.html) instance is created with `Kiji.Factory.open()`,
or a ['KijiTable']({{site.api_schema_1_1_0}}/KijiTable.html) is opened with `Kiji.openTable(name)`,
it has an automatic reference count of 1. You should call `kiji.release()` or `table.release()` or use
[`ResourceUtils`]({{site.api_schema_1_1_0}}/util/ResourceUtils.html)`.releaseOrLog(kiji)` or
...
A [`Kiji`]({{site.api_schema_1_1_0}}/Kiji.html) object or
[`KijiTable`]({{site.api_schema_1_1_0}}/KijiTable.html) will close itself and free its underlying
...
[`KijiTableReader`]({{site.api_schema_1_1_0}}/KijiTableReader.html) class. We have included an
...
[`KijiTableReader`]({{site.api_schema_1_1_0}}/KijiTableReader.html).
{% highlight java %}
reader = table.openTableReader();
{% endhighlight %}

#### Looking up the requested entry
Create an [`EntityId`]({{site.api_schema_1_1_0}}/EntityId.html) to retrieve a contact
...
[`EntityId`]({{site.api_schema_1_1_0}}/EntityId.html) and data request to our table reader.
Doing so results in a [`KijiRowData`]({{site.api_schema_1_1_0}}/KijiRowData.html) containing
