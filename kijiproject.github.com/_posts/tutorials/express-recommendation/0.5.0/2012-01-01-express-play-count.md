...
Data can be read from a Kiji table by using [`KijiInput`](({{site.api_express_0_5_0}}/KijiInput.html)). 
...
[`KijiSlice`]({{site.api_express_0_5_0}}/KijiSlice.html). For our purposes, we can imagine a
[`KijiSlice`]({{site.api_express_0_5_0}}/KijiSlice.html) as a list of cells, each one a different
...
<div id="accordion-container">
  ...
  <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-express-music/raw/kiji-express-music-0.5.0/src/main/scala/org/kiji/express/music/SongPlayCounter.scala"> </script>
  </div>
</div>
