...
[`DSL`]({{site.api_express_0_1_0}}/DSL$.html).
...
[`KijiSlice`]({{site.api_express_0_1_0}}/KijiSlice.html). For our purposes, we can imagine a
[`KijiSlice`]({{site.api_express_0_1_0}}/KijiSlice.html) as a list of cells, each one a different
...
<div class="userinput">
{% highlight bash %}
express job ${MUSIC_EXPRESS_HOME}/lib/kiji-express-music-0.1.0.jar org.kiji.express.music.SongPlayCounter --table-uri \
