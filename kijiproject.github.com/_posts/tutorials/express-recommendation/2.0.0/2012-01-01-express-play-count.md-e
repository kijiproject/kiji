...
Data can be read from a Kiji table by using [`KijiInput`](({{site.api_express_2.0.0-rc1}}/KijiInput.html).
...
<div id="accordion-container">
  ...
  <div class="accordion-content">
        <script src="http://gist-it.appspot.com/github/kijiproject/kiji-express-music/raw/kiji-express-music-2.0.0/src/main/scala/org/kiji/express/music/SongPlayCounter.scala"> </script>
  </div>
</div>
