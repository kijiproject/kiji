...
<div id="accordion-container">
  ...
  <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-express-music/raw/kiji-express-music-0.2.0/src/main/scala/org/kiji/express/music/SongPlayCounter.scala"> </script>
  </div>
</div>
...
[`DSL`]({{site.api_express_0_2_0}}/DSL$.html).
...
[`KijiSlice`]({{site.api_express_0_2_0}}/KijiSlice.html). For our purposes, we can imagine a
[`KijiSlice`]({{site.api_express_0_2_0}}/KijiSlice.html) as a list of cells, each one a different
