...
<div id="accordion-container">
  <h2 class="accordion-header"> SongMetadataBulkImporter.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-music/raw/kiji-music-1.0.0/src/main/java/org/kiji/examples/music/bulkimport/SongMetadataBulkImporter.java"> </script>
  </div>
  <h2 class="accordion-header"> JSONBulkImporter.java </h2>
    <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-mapreduce-lib/raw/kiji-mapreduce-lib-root-1.0.0/kiji-mapreduce-lib/src/main/java/org/kiji/mapreduce/lib/bulkimport/JSONBulkImporter.java"> </script>
  </div>
</div>
...
[text input format]({{site.userguide_mapreduce_1_0_0}}/command-line-tools/#input) where the
...
Then build an [Avro]({{site.userguide_mapreduce_1_0_0}}/working-with-avro) metadata record from the parsed JSON.
...
We create an [`EntityId`]({{site.api_schema_1_1_0}}/EntityId.html) object in order to use the song ID
as the row key.
