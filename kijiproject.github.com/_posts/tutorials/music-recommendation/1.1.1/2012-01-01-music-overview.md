...
* Use a [gatherer]({{ site.userguide_mapreduce_1_2_1 }}/gatherers) to generate the next-song pairs,
  and use a generic MapReduce job to aggregate them into counts.
* Use a [producer]({{ site.userguide_mapreduce_1_2_1 }}/producers) and join together data sources, to
...
[`EntityId`]({{site.api_schema_1_3_2}}/EntityId.html).
