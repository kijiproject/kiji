...
* Use a [gatherer]({{ site.userguide_mapreduce_1_2_2 }}/gatherers) to generate the next-song pairs,
  and use a generic MapReduce job to aggregate them into counts.
* Use a [producer]({{ site.userguide_mapreduce_1_2_2 }}/producers) and join together data sources, to
