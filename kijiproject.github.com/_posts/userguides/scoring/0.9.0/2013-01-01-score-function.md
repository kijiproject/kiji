...
<div id="accordion-container">
  <h2 class="accordion-header"> ScoreFunction.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-scoring/raw/kiji-scoring-root-0.9.0/src/main/java/org/kiji/scoring/ScoreFunction.java"> </script>
  </div>
</div>
