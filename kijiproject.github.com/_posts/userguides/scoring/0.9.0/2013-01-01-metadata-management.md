...
<div id="accordion-container">
  <h2 class="accordion-header"> KijiFreshnessManager.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-scoring/raw/kiji-scoring-root-0.9.0/kiji-scoring/src/main/java/org/kiji/scoring/KijiFreshnessManager.java"> </script>
  </div>
</div>
