...
<div id="accordion-container">
  <h2 class="accordion-header"> FreshenerContext.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-scoring/raw/kiji-scoring-root-0.11.0/src/main/java/org/kiji/scoring/FreshenerContext.java"> </script>
  </div>
</div>
