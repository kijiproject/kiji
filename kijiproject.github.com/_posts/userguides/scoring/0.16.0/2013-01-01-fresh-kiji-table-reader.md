...
<div id="accordion-container">
  <h2 class="accordion-header"> FreshKijiTableReader.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/kijiproject/kiji-scoring/raw/kiji-scoring-root-0.16.0/src/main/java/org/kiji/scoring/FreshKijiTableReader.java"> </script>
  </div>
</div>
