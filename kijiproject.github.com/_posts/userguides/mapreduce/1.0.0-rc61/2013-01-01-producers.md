...
A [`KijiProducer`]({{site.api_mr_rc61}}/produce/KijiProducer.html) executes a function over a subset
...
Each producer must extend [`KijiProducer`]({{site.api_mr_rc61}}/produce/KijiProducer.html) and must
...
external stores through [`KeyValueStore`]({{site.api_mr_rc61}}/kvstore/KeyValueStore.html)s by
implementing `Map<String, KeyValueStore<?, ?>> getRequiredStores()`. This method should construct
and return a map specifying all the
[`KeyValueStore`]({{site.api_mr_rc61}}/kvstore/KeyValueStore.html)s that the producer wants to
access. The [`KeyValueStore`]({{site.api_mr_rc61}}/kvstore/KeyValueStore.html)s may then be accessed
from the `produce()` method through the
[`ProducerContext`]({{site.api_mr_rc61}}/produce/ProducerContext.html). For more details, you may
check the [Key-Value Stores]({{site.userguide_mapreduce_rc61}}/key-value-stores) section in this
guide.
...
to use a [`KeyValueStore`]({{site.api_mr_rc61}}/kvstore/KeyValueStore.html), it should be opened once
...
* [`AllVersionsSingleInputProducer`]({{site.api_mrlib_rc61}}/produce/AllVersionsSingleInputProducer.html)
  and [`SingleInputProducer`]({{site.api_mrlib_rc61}}/produce/SingleInputProducer.html) are
  ...
  [`SingleInputProducer`]({{site.api_mrlib_rc61}}/produce/SingleInputProducer.html)).
* [`RegexProducer`]({{site.api_mrlib_rc61}}/produce/RegexProducer.html) is an abstract subclass of
  [`SingleInputProducer`]({{site.api_mrlib_rc61}}/produce/SingleInputProducer.html). Subclasses must
  ...
  capturing group. [`RegexProducer`]({{site.api_mrlib_rc61}}/produce/RegexProducer.html) contains a
  `produce()` method which will write that group to the output column. Both input and output should
  be strings.
* [`ConfiguredRegexProducer`]({{site.api_mrlib_rc61}}/produce/ConfiguredRegexProducer.html) is a
  concrete implementation of [`RegexProducer`]({{site.api_mrlib_rc61}}/produce/RegexProducer.html)
...
* [`IdentityProducer`]({{site.api_mrlib_rc61}}/produce/IdentityProducer.html) is another concrete
