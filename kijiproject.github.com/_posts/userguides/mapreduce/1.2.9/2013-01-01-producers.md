...
A [`KijiProducer`]({{site.api_mr_1_2_9}}/produce/KijiProducer.html) executes a function over a subset
...
Each producer must extend [`KijiProducer`]({{site.api_mr_1_2_9}}/produce/KijiProducer.html) and must
 ...
 * `KijiDataRequest getDataRequest()`. This method specifies the columns retrieved while scanning
   ...
   [`KijiDataRequest`]({{site.api_schema_1_5_0}}/KijiDataRequest.html).
 ...
 * `void produce(KijiRowData input, ProducerContext context)`. This method contains the logic to
   ...
   [`KijiDataRequest`]({{site.api_schema_1_5_0}}/KijiDataRequest.html) returned from
   `getDataRequest()`.
...
* [`AllVersionsSingleInputProducer`]({{site.api_mrlib_1_1_8}}/produce/AllVersionsSingleInputProducer.html)
  ...
  [`KijiDataRequest`]({{site.api_schema_1_5_0}}/KijiDataRequest.html) in `getDataRequest()`. The
