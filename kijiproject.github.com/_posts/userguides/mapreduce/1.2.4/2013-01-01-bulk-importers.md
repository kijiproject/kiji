...
[`KijiBulkImporter`]({{site.api_mr_1_2_4}}/bulkimport/KijiBulkImporter.html).
...
[`KijiBulkImporter`]({{site.api_mr_1_2_4}}/bulkimport/KijiBulkImporter.html) with the types of the key
...
* `EntityId getEntityId(Object... components)` returns the
  [`EntityId`]({{site.api_schema_1_3_6}}/EntityId.html) for a row in a Kiji table given a string
  identifier.
