...
[`KijiBulkImporter`]({{site.api_mr_1_0_0_rc62}}/bulkimport/KijiBulkImporter.html).
...
[`KijiBulkImporter`]({{site.api_mr_1_0_0_rc62}}/bulkimport/KijiBulkImporter.html) with the types of the key
...
* `EntityId getEntityId(String kijiRowKey)` returns the
  [`EntityId`]({{site.api_schema_1_0_3}}/EntityId.html) for a row in a Kiji table given a string
  identifier.
...
* [`CSVParser`]({{site.api_mrlib_1_0_0_rc61}}/util/CSVParser.html) - parses delimited CSV (Comma Separated
  Value) data into component fields.  This parser also handles TSV (Tab Separated Value) data.

* [`CommonLogParser`]({{site.api_mrlib_1_0_0_rc61}}/util/CommonLogParser.html) - parses Common Log Format
...
* [`CSVBulkImporter`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/CSVBulkImporter.html) - takes in CSV files
  and writes a row for each line in the file.

* [`CommonLogBulkImporter`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/CommonLogBulkImporter.html) - takes in
  an Apache web server log and produces a row for each client request.

* [`JSONBulkImporter`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/JSONBulkImporter.html) - takes in a text
  file with a JSON object on each line and produces a row for each object.

* [`XMLBulkImporter`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/XMLBulkImporter.html) - takes a text encoded
...
[`DescribedInputTextBulkImporter`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/DescribedInputTextBulkImporter.html)
which contains helper functions and can be configured via a
[`KijiTableImportDescriptor`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/KijiTableImportDescriptor.html).
[`KijiTableImportDescriptor`]({{site.api_mrlib_1_0_0_rc61}}/bulkimport/KijiTableImportDescriptor.html) is
