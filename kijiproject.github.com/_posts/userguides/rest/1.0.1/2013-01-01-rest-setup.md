...
point to the root directory:
    ...
    export KIJI_REST_HOME=/path/to/tarball/kiji-rest-1.0.1
...
(Non-BentoBox users will also see `kiji-rest-1.0.1.jar`.)
...
1. Unpack the `kiji-rest` tarball as the `/opt/wibi/kiji-rest directory`:
        ...
        $ tar -xzf kiji-rest-1.0.1-release.tar.gz -C /opt/wibi/
        $ ln -s kiji-rest-1.0.1 kiji-rest
