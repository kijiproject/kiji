...
point to the root directory:
    ...
    export KIJI_REST_HOME=/path/to/tarball/kiji-rest-1.4.0
...
(Non-BentoBox users will also see `kiji-rest-1.4.0.jar`.)
...
1. Unpack the `kiji-rest` tarball as the `/opt/wibi/kiji-rest directory`:
        ...
        $ tar -xzf kiji-rest-1.4.0-release.tar.gz -C /opt/wibi/
        $ ln -s kiji-rest-1.4.0 kiji-rest
