...
See [Managing Data]({{site.userguide_schema_rc2}}/managing-data#layouts) for details.
...
See [Managing Data]({{site.userguide_schema_rc2}}/managing-data#layouts) for more
