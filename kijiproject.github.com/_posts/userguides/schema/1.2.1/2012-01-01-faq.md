...
See [Managing Data]({{site.userguide_schema_1_2_1}}/managing-data#layouts) for details.
...
See [Managing Data]({{site.userguide_schema_1_2_1}}/managing-data#layouts) for more
