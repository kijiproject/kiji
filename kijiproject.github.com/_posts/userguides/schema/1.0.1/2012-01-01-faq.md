...
See [Managing Data]({{site.userguide_schema_1_0_1}}/managing-data#layouts) for details.
...
See [Managing Data]({{site.userguide_schema_1_0_1}}/managing-data#layouts) for more
