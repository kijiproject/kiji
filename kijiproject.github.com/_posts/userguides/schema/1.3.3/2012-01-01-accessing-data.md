...
The [`KijiTableReader`]({{site.api_schema_1_3_3}}/KijiTableReader.html) class provides a `get(...)` method to read typed data from a Kiji table row.
The row is addressed by its [`EntityId`]({{site.api_schema_1_3_3}}/EntityId.html)
(which can be retrieved from the [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html) instance
using the [`getEntityId()`]({{site.api_schema_1_3_3}}/KijiTable.html#getEntityId%28java.lang.String%29) method).
Specify the desired cells from the rows with a [`KijiDataRequest`]({{site.api_schema_1_3_3}}/KijiDataRequest.html).
See the [`KijiDataRequest`]({{site.api_schema_1_3_3}}/KijiDataRequest.html) documentation for details.

In general, [`Kiji`]({{site.api_schema_1_3_3}}/Kiji.html) and [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html) instances should only be opened once over the life of an application
([`EntityIdFactory`]({{site.api_schema_1_3_3}}/EntityIdFactory.html)s should also be reused).
[`KijiTablePool`]({{site.api_schema_1_3_3}}/KijiTablePool.html) can be used to maintain a pool of opened [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html) objects for reuse.
To initially open a [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html):
...
To read from an existing [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html),
create a [`KijiDataRequest`]({{site.api_schema_1_3_3}}/KijiDataRequest.html) specifying the columns of data to return.
Then, query for the desired [`EntityId`]({{site.api_schema_1_3_3}}/EntityId.html),
using a [`KijiTableReader`]({{site.api_schema_1_3_3}}/KijiTableReader.html).
You can get a [`KijiTableReader`]({{site.api_schema_1_3_3}}/KijiTableReader.html) for a [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html) using the [`openTableReader()`]({{site.api_schema_1_3_3}}/KijiTable.html#openTableReader%28%29) method.
...
The [`KijiTableReader`]({{site.api_schema_1_3_3}}/KijiTableReader.html) also implements a [`bulkGet(...)`]({{site.api_schema_1_3_3}}/KijiTableReader.html#bulkGet%28java.util.List%2C%20org.kiji.schema.KijiDataRequest%29) method
for retrieving data for a list of [`EntityId`]({{site.api_schema_1_3_3}}/EntityId.html)s.
...
If you need to process a range of rows, you may use a [`KijiRowScanner`]({{site.api_schema_1_3_3}}/KijiRowScanner.html):
...
The [`KijiTableWriter`]({{site.api_schema_1_3_3}}/KijiTableWriter.html) class provides a `put(...)` method to write or update cells in a Kiji table.
The cell is addressed by its entity ID, column family, column qualifier, and timestamp.
You can get a [`KijiTableWriter`]({{site.api_schema_1_3_3}}/KijiTableWriter.html) for a [`KijiTable`]({{site.api_schema_1_3_3}}/KijiTable.html) using the [`openTableWriter()`]({{site.api_schema_1_3_3}}/KijiTable.html#openTableWriter%28%29) method.
...
The [`AtomicKijiPutter`]({{site.api_schema_1_3_3}}/AtomicKijiPutter.html) class provides the ability
...
write it by using
[`commit()`]({{site.api_schema_1_3_3}}/AtomicKijiPutter.html#commit%28%29).
...
[`checkAndCommit(family, qualifier, value)`]({{site.api_schema_1_3_3}}/AtomicKijiPutter.html#checkAndCommit%28java.lang.String%2C%20java.lang.String%2C%20T)
...
[`KijiBufferedWriter`]({{site.api_schema_1_3_3}}/KijiBufferedWriter.html) class provides local buffering
...
[`flush`]({{site.api_schema_1_3_3}}/KijiBufferedWriter.html#flush%28%29) or
[`close`]({{site.api_schema_1_3_3}}/KijiBufferedWriter.html#close%28%29). The size of the local
buffer can be managed using
[`setBufferSize`]({{site.api_schema_1_3_3}}/KijiBufferedWriter.html#setBufferSize%28long%29). The buffered
...
"counter". See [Managing Data]({{site.userguide_schema_1_3_3}}/managing-data#layouts)
...
In addition to that, the [`KijiTableWriter`]({{site.api_schema_1_3_3}}/KijiTableWriter.html) class also provides a method to atomically increment counter values.
...
The [`KijiTableInputFormat`]({{site.api_schema_1_3_3}}/mapreduce/KijiTableInputFormat.html) provides the necessary functionality to read from a Kiji table in a
MapReduce job. To configure a job to read from a Kiji table, use [`KijiTableInputFormat`]({{site.api_schema_1_3_3}}/mapreduce/KijiTableInputFormat.html)'s
...
[`KijiTableInputFormat`]({{site.api_schema_1_3_3}}/mapreduce/KijiTableInputFormat.html) outputs keys of type [`EntityId`]({{site.api_schema_1_3_3}}/EntityId.html) and values of type [`KijiRowData`]({{site.api_schema_1_3_3}}/KijiRowData.html). This
...
[`KijiTableWriter`]({{site.api_schema_1_3_3}}/KijiTableWriter.html) as before. You should also set
