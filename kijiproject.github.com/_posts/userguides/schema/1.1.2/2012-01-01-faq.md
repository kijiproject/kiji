...
See [Managing Data]({{site.userguide_schema_1_1_2}}/managing-data#layouts) for details.
...
See [Managing Data]({{site.userguide_schema_1_1_2}}/managing-data#layouts) for more
