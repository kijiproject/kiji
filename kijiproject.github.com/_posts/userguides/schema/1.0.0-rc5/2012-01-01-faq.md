...
See [Managing Data]({{site.userguide_schema_rc5}}/managing-data#layouts) for details.
...
See [Managing Data]({{site.userguide_schema_rc5}}/managing-data#layouts) for more
