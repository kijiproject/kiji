...
The [`KijiTableInputFormat`]({{site.api_schema_1_5_0}}/mapreduce/KijiTableInputFormat.html) provides the necessary functionality to read from a Kiji table in a
