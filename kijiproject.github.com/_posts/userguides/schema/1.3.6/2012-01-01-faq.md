...
See [Managing Data]({{site.userguide_schema_1_3_6}}/managing-data#layouts) for details.
...
See [Managing Data]({{site.userguide_schema_1_3_6}}/managing-data#layouts) for more
