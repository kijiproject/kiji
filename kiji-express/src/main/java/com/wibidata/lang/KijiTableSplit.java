...
public class KijiTableSplit implements InputSplit {
  ...
  /**
   * A default constructor to be used with reflection.
   */
  ...
  /**
   * Creates a new Kiji table split that delegates to an underlying HBase table split.
   *
   * @param tableSplit to delegate to.
   */
