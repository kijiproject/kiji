...
public class TestNodeReducer {
  public static class MyNodeReducer extends NodeReducer<Text> {
    @Override
    public void reduceNodes(Text key, Iterable<Node> values, Context context)
